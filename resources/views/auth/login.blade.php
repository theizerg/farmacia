            ...
            <div class="card-group">
                          ...
                          <input type="hidden" id="_token" value="{{ csrf_token() }}">  
                            <div class="form-group mb-3">
                              <div class="input-group input-group-alternative">
                                ...
                                <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}"  autocomplete="username" autofocus placeholder="Usuario">
                ...
                <div class="card text-white blue darken-4 py-5 mt-5 d-md-down-none" style="width:44%">
                    <div class="card-body text-center ">
                        <h2 class="text-white">SISVENTAS</h2>
                        <small class="text-center">
                           Sistema automatizado para el control de ventas 
                        </small>
                        <br>
